...
val inline_constants_of_lustre_type: TC.tc_context -> LA.lustre_type -> int -> LA.lustre_type
...
val simplify_expr: ?is_guarded:bool -> ?indices:HString.t list -> TC.tc_context -> int -> LA.expr -> LA.expr
