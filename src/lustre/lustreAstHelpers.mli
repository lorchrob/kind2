...
val calls_of_expr: expr -> NodeId.Set.t 
...
val get_last_node_name: declaration list -> NodeId.t option
(** Gets the name of the last node declared in the file. *)

val move_node_to_last: NodeId.t -> declaration list -> declaration list
