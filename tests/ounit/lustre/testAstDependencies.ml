...
let linear_decls = [
    LA.TypeDecl (dspan, LA.AliasType(dp, HString.mk_hstring "t0", [], LA.UserType (dp, [], HString.mk_hstring "t1", None)))
  ; LA.TypeDecl (dspan, LA.AliasType(dp, HString.mk_hstring "t1", [], LA.UserType (dp, [], HString.mk_hstring "t2", None)))
  ...
  ; LA.ConstDecl (dspan, LA.TypedConst (dp, HString.mk_hstring "c",
    LA.Const (dp, Num (HString.mk_hstring "1")), LA.UserType (dp, [], HString.mk_hstring "t0", None)))
  ]
...
let circular_decls = [
    LA.TypeDecl (dspan, LA.AliasType(dp, HString.mk_hstring "t0", [], LA.UserType (dp, [], HString.mk_hstring "t1", None)))
  ; LA.TypeDecl (dspan, LA.AliasType(dp, HString.mk_hstring "t1", [], LA.UserType (dp, [], HString.mk_hstring "t2", None)))
  ; LA.TypeDecl (dspan, LA.AliasType(dp, HString.mk_hstring "t2", [], LA.UserType (dp, [], HString.mk_hstring "t0", None)))
  ; LA.ConstDecl (dspan, LA.TypedConst (dp, HString.mk_hstring "c",
    LA.Const (dp, Num (HString.mk_hstring "1")), LA.UserType (dp, [], HString.mk_hstring "t0", None)))  ]
